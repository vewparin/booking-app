    ...
    return (
        <>
            <div className="flex gap-2">
                ...
                <button onClick={addPhotoByLink} className="bf-gray-200 px-4 rounded-2xl">Add&nbsp;photo</button>
            </div>
            ...
            <div className="mt-2 grid gap-2 grid-cols-3 md:grid-cols-4 lg:grid-cols-6">
                ...
                <label className=" h-32 cursor-pointer flex items-center gap-2 justify-center border bg-transparent rounded-2xl p-8 text-2xl text-gray-600">
