        ...
        <div>
            ...
            <div>
                {bookings?.length > 0 && bookings.map(booking => (
                    <Link to={`/account/bookings/${booking._id}`} className="gap-5 bg-gray-200 rounded-1xl overflow-hidden">
                        <div>
                            <HotelsPicture place={booking.place} />
                        </div>
                        <div className="py-3 pr-3 grow">
                            <h2 className="font-bold text-xl">{booking.place.title}</h2>
                            <div className=" flex  gap-2 border-t border-gray-300 mt-2 py-2 text-gray-500">
